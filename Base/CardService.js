 ...
 * Sets an authorization action that opens a URL to the authorization flow when the object is
 clicked. This will open the URL in a new window and when the user finishes the authorization
 flow and returns to the application, the addon will reload.
 ...
 *
 * @return {CardService.ComposeActionResponse} a validated ComposeActionResponse.
 */
 ...
 * Sets the key that identifies this switch in the event object that is generated when there is a
 UI interaction. Not visible to the user. Required, must be unique.
 *
