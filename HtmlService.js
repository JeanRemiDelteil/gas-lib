 ...
 */
HtmlService.SandboxMode = function(){};
 ...
 * @type {{}}
 */
HtmlService.SandboxMode.prototype.EMULATED = {};
 ...
 * @type {{}}
 */
HtmlService.SandboxMode.prototype.IFRAME = {};
 ...
 * A sandbox mode that is built on top of ECMAScript 5 strict mode. This mode has been the default
 ...
 which all scripts will use <code>IFRAME</code> mode.

 <p>This mode imposes fewer restrictions than <code>EMULATED</code> mode and generally runs faster,
 but is more restrictive and slower than <code>IFRAME</code> mode. If this mode is set, certain older
 ...
 * @type {{}}
 */
HtmlService.SandboxMode.prototype.NATIVE = {};
 ...
 * Appends new content to the content of this <code>HtmlOutput</code>, using contextual escaping.
 ...
 <p>This method will correctly escape content based on the current state of the
 <code>HtmlOutput</code>, so that the result will be a safe string with no markup or side affects.
 ...
 or markup that you append causes unexpected code execution.</p>
 ...
 * Gets the URL for a favicon link tag added to the page by calling
 <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/html-output.html#setFaviconUrl(String)'>setFaviconUrl(iconUrl)</a></code>. Favicon link tags included directly in an Apps Script HTML file
 are ignored.
 ...
 * Gets the initial height of the
 <a href="https://developers.google.com/apps-script/guides/dialogs">custom dialog</a> in Google
 Docs, Sheets, or Forms. If the <code>HtmlOutput</code> is published as a web app instead, this
 method returns <code>null</code>. To resize a dialog that is already open, call
 <a href="https://developers.google.com/apps-script/guides/html/communication#resizing_dialogs_in_google_apps"><code>google.script.host.setHeight(height)</code></a>
 in client-side code.
 ...
 * Gets an array of objects that represent meta tags added to the page by calling
 <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/html-output.html#addMetaTag(String,String)'>addMetaTag(name, content)</a></code>. Meta tags included directly in an Apps Script HTML file
 are ignored.
 ...
 *
 * @return {HtmlService.HtmlOutputMetaTag[]} an array of objects that represent meta tags added to the page by calling
     <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/html-output.html#addMetaTag(String,String)'>addMetaTag(name, content)</a></code>
 */
 ...
 * Gets the initial width of the
 <a href="https://developers.google.com/apps-script/guides/dialogs">custom dialog</a>
 in Google Docs, Sheets, or Forms. If the <code>HtmlOutput</code> is published as a web app instead,
 this method returns <code>null</code>. To resize a dialog that is already open, call
 <a href="https://developers.google.com/apps-script/guides/html/communication#resizing_dialogs_in_google_apps"><code>google.script.host.setWidth(width)</code></a>
 in client-side code.
...
/**
 * Sets the <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/sandbox-mode.html'>sandbox mode</a></code> used for client-side scripts. To protect users
 ...
 <a href="/apps-script/guides/html/restrictions">guide to restrictions in HTML service</a>.

 <p>If a script does not set a sandbox mode, Apps Script uses <code>NATIVE</code> mode as the
 default. Prior to February 2014, the default was <code>EMULATED</code>. The default is subject to
 change.</p>
 ...
 9. By contrast, <code>EMULATED</code> mode is more likely to work in
 <a href="http://caniuse.com/use-strict">older browsers that do not support ECMAScript 5 strict
 mode</a>, most notably Internet Explorer 9. <code>NATIVE</code> mode is the middle ground. If
 <code>NATIVE</code> mode is set but not supported in the user's browser, the sandbox mode falls back
 to <code>EMULATED</code> mode for that user.</p>
 ...
 <code>google.script.sandbox.mode</code>. Note that this property returns the actual mode on the
 ...
 * Generates a string of JavaScript code, based on the template file, that can be evaluated. This
 ...
 <code>eval(&lt;code&gt;)</code> will return a new <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/html-output.html'>HtmlOutput</a></code> object with the content of
 ...
 <code>Logger.log(&lt;code&gt;)</code> to see what was produced.

 <p>Evaluating this code will implicitly bind in all variables in the current scope. In general,
 it's preferable to use the <code><a target='_blank' href='https://developers.google.com/apps-script/reference/html/html-template.html#evaluate()'>evaluate()</a></code> method, which takes explicit bindings.</p>
